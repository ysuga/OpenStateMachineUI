 ...
 *
 */
public class OrGuardSettingDialogFactory implements GuardSettingDialogFactory {
	 ...
	 * </div>
	 */
	public OrGuardSettingDialogFactory() {
	...
	public AbstractGuardSettingDialog createGuardSettingDialog(
		...
		return new OrGuardSettingDialog(transitionSettingDialog);
	}
