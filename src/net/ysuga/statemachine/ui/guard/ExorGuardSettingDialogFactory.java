 ...
 *
 */
public class ExorGuardSettingDialogFactory implements GuardSettingDialogFactory {
	 ...
	 * </div>
	 */
	public ExorGuardSettingDialogFactory() {
	...
	public AbstractGuardSettingDialog createGuardSettingDialog(
		...
		return new ExorGuardSettingDialog(transitionSettingDialog);
	}
