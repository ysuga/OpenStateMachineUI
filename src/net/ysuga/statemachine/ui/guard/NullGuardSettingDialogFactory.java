 ...
 *
 */
public class NullGuardSettingDialogFactory implements
	 ...
	 * </div>
	 */
	public NullGuardSettingDialogFactory() {
	...
	public AbstractGuardSettingDialog createGuardSettingDialog(
		...
		return new NullGuardSettingDialog(transitionSettingDialog, null);
	}
